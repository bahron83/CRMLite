...
namespace CRMLiteBusiness
{
    ...
    /// in a single graph.
    /// </summary>
    public  class CRMLiteDataImporter
    {
        public static bool EnsureAlbumData(CRMLiteContext context, string jsonDataFilePath)
        {
            bool hasData = false;
            try
            {
        ...
        /// <returns></returns>
        public static int ImportFromJson(CRMLiteContext context, string json)
        {
